...
def decoder(inputs, convs, dropout=None):
    ...
    c6 = decoder_block(inputs, f4, n_filters=64, dropout=dropout)
    c7 = decoder_block(c6, f3, n_filters=64, dropout=dropout)
    c8 = decoder_block(c7, f2, n_filters=64, dropout=dropout)
    c9 = decoder_block(c8, f1, n_filters=64, dropout=dropout)

    # output block
    c10 = conv2d_block(c9, n_filters=64, kernel_size=3)

    return c10


def det_net_2(inputs, dropout=None):
